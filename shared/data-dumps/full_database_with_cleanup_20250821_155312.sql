...
ALTER TABLE IF EXISTS ONLY public.user_downloads DROP CONSTRAINT IF EXISTS user_downloads_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.user_downloads DROP CONSTRAINT IF EXISTS user_downloads_software_id_softwares_id_fk;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_seller_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_order_id_fkey;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_buyer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.softwares DROP CONSTRAINT IF EXISTS softwares_created_by_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.softwares DROP CONSTRAINT IF EXISTS softwares_category_id_categories_id_fk;
ALTER TABLE IF EXISTS ONLY public.service_requests DROP CONSTRAINT IF EXISTS service_requests_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_quotations DROP CONSTRAINT IF EXISTS service_quotations_service_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_quotations DROP CONSTRAINT IF EXISTS service_quotations_admin_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_projects DROP CONSTRAINT IF EXISTS service_projects_service_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_projects DROP CONSTRAINT IF EXISTS service_projects_quotation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_projects DROP CONSTRAINT IF EXISTS service_projects_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_projects DROP CONSTRAINT IF EXISTS service_projects_admin_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_payments DROP CONSTRAINT IF EXISTS service_payments_service_project_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_payments DROP CONSTRAINT IF EXISTS service_payments_quotation_id_fkey;
ALTER TABLE IF EXISTS ONLY public.service_payments DROP CONSTRAINT IF EXISTS service_payments_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.seller_profiles DROP CONSTRAINT IF EXISTS seller_profiles_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sales_analytics DROP CONSTRAINT IF EXISTS sales_analytics_seller_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sales_analytics DROP CONSTRAINT IF EXISTS sales_analytics_product_id_fkey;
ALTER TABLE IF EXISTS ONLY public.reviews DROP CONSTRAINT IF EXISTS reviews_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.quotes DROP CONSTRAINT IF EXISTS quotes_developer_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.products DROP CONSTRAINT IF EXISTS products_seller_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.product_reviews DROP CONSTRAINT IF EXISTS product_reviews_product_id_products_id_fk;
ALTER TABLE IF EXISTS ONLY public.product_reviews DROP CONSTRAINT IF EXISTS product_reviews_order_id_orders_id_fk;
ALTER TABLE IF EXISTS ONLY public.product_reviews DROP CONSTRAINT IF EXISTS product_reviews_buyer_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.portfolios DROP CONSTRAINT IF EXISTS portfolios_developer_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.portfolio_reviews DROP CONSTRAINT IF EXISTS portfolio_reviews_user_id_users_id_fk;
ALTER TABLE IF EXISTS ONLY public.portfolio_reviews DROP CONSTRAINT IF EXISTS portfolio_reviews_portfolio_id_portfolios_id_fk;
...
ALTER TABLE IF EXISTS ONLY public.external_requests DROP CONSTRAINT IF EXISTS external_requests_client_id_fkey;
ALTER TABLE IF EXISTS ONLY public.external_requests DROP CONSTRAINT IF EXISTS external_requests_assigned_developer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_rooms DROP CONSTRAINT IF EXISTS chat_rooms_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_room_members DROP CONSTRAINT IF EXISTS chat_room_members_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.chat_room_members DROP CONSTRAINT IF EXISTS chat_room_members_room_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.user_downloads DROP CONSTRAINT IF EXISTS user_downloads_pkey;
ALTER TABLE IF EXISTS ONLY public.support_tickets DROP CONSTRAINT IF EXISTS support_tickets_pkey;
ALTER TABLE IF EXISTS ONLY public.softwares DROP CONSTRAINT IF EXISTS softwares_pkey;
ALTER TABLE IF EXISTS ONLY public.session DROP CONSTRAINT IF EXISTS session_pkey;
ALTER TABLE IF EXISTS ONLY public.service_requests DROP CONSTRAINT IF EXISTS service_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.service_quotations DROP CONSTRAINT IF EXISTS service_quotations_pkey;
ALTER TABLE IF EXISTS ONLY public.service_projects DROP CONSTRAINT IF EXISTS service_projects_pkey;
ALTER TABLE IF EXISTS ONLY public.service_payments DROP CONSTRAINT IF EXISTS service_payments_pkey;
ALTER TABLE IF EXISTS ONLY public.seller_profiles DROP CONSTRAINT IF EXISTS seller_profiles_user_id_unique;
...
ALTER TABLE IF EXISTS ONLY public.sales_analytics DROP CONSTRAINT IF EXISTS sales_analytics_pkey;
...
ALTER TABLE IF EXISTS ONLY public.portfolio_reviews DROP CONSTRAINT IF EXISTS portfolio_reviews_pkey;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_pkey;
ALTER TABLE IF EXISTS ONLY public.orders DROP CONSTRAINT IF EXISTS orders_pkey;
ALTER TABLE IF EXISTS ONLY public.order_items DROP CONSTRAINT IF EXISTS order_items_pkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_pkey;
ALTER TABLE IF EXISTS ONLY public.messages DROP CONSTRAINT IF EXISTS messages_pkey;
ALTER TABLE IF EXISTS ONLY public.external_requests DROP CONSTRAINT IF EXISTS external_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.chat_rooms DROP CONSTRAINT IF EXISTS chat_rooms_pkey;
ALTER TABLE IF EXISTS ONLY public.chat_room_members DROP CONSTRAINT IF EXISTS chat_room_members_pkey;
...
ALTER TABLE IF EXISTS public.user_downloads ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.support_tickets ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.softwares ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.service_requests ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.service_quotations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.service_projects ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.service_payments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.seller_profiles ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.sales_analytics ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.portfolio_reviews ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.external_requests ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.chat_rooms ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.chat_room_members ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.user_downloads_id_seq;
DROP TABLE IF EXISTS public.user_downloads;
DROP SEQUENCE IF EXISTS public.support_tickets_id_seq;
DROP TABLE IF EXISTS public.support_tickets;
DROP SEQUENCE IF EXISTS public.softwares_id_seq;
DROP TABLE IF EXISTS public.softwares;
DROP TABLE IF EXISTS public.session;
DROP SEQUENCE IF EXISTS public.service_requests_id_seq;
DROP TABLE IF EXISTS public.service_requests;
DROP SEQUENCE IF EXISTS public.service_quotations_id_seq;
DROP TABLE IF EXISTS public.service_quotations;
DROP SEQUENCE IF EXISTS public.service_projects_id_seq;
DROP TABLE IF EXISTS public.service_projects;
DROP SEQUENCE IF EXISTS public.service_payments_id_seq;
DROP TABLE IF EXISTS public.service_payments;
DROP SEQUENCE IF EXISTS public.seller_profiles_id_seq;
DROP TABLE IF EXISTS public.seller_profiles;
DROP SEQUENCE IF EXISTS public.sales_analytics_id_seq;
...
DROP SEQUENCE IF EXISTS public.portfolio_reviews_id_seq;
DROP TABLE IF EXISTS public.portfolio_reviews;
...
DROP SEQUENCE IF EXISTS public.external_requests_id_seq;
...
DROP SEQUENCE IF EXISTS public.chat_room_members_id_seq;
...
DROP TYPE IF EXISTS public.service_quotation_status;
DROP TYPE IF EXISTS public.service_payment_type;
...
DROP TYPE IF EXISTS public.external_request_status;
--
...
8	Test Buyer	buyer@test.com	0378246333	Project Name: toi muon lam app mua ban tien so\nCompany: fpt\nDescription: lam app that dep co tinh nang giong san binance\nRequirements: - Node.js\n- Python\n- AWS\n- Docker\n- Next.js\n- Laravel\nBudget: 1.000.000 ₫\nTimeline: August 22nd, 2025	in_progress	2025-08-15 04:15:09.351002	\N	\N	\N	\N	\N	\N	\N	\N	\N	normal	[2025-08-15T04:43:22.520Z] Status changed to 'in_progress': No reason provided	\N	\N	2025-08-15 04:43:22.52
\.
...
COPY public.products (id, seller_id, title, description, price, images, category, created_at, updated_at, price_type, stock_quantity, download_link, product_files, tags, license_info, status, featured, total_sales, avg_rating, pricing_rows) FROM stdin;
2	2	Advanced Captcha Solver Tool	AI-powered captcha solving tool with 99% success rate. Supports reCAPTCHA v2, v3, hCaptcha, and FunCaptcha. Includes API access and documentation.	500000	{https://via.placeholder.com/300x200?text=Captcha+Solver}	Captcha Solvers	2025-08-02 06:55:39.432431	2025-08-02 06:55:39.432431	fixed	10	\N	\N	\N	\N	approved	f	1	\N	\N
1	2	Updated Product Title	Updated comprehensive test product description with sufficient length to meet requirements	39.99	{https://via.placeholder.com/300x200?text=Gmail+Accounts}	Software Licenses	2025-08-02 06:55:39.432431	2025-08-02 06:55:39.432431	fixed	10	\N	\N	\N	\N	approved	f	5	\N	\N
5	2	Test Product API Fixed	This is a comprehensive test product description with sufficient length to meet requirements	29.99	\N	Software Licenses	2025-08-02 16:51:09.691862	2025-08-02 16:51:09.691862	fixed	10	\N	\N	{test,software,licenses}	\N	pending	f	0	\N	\N
6	2	Test Product	Test description	29.99	\N	Software Licenses	2025-08-03 10:54:36.64279	2025-08-03 10:54:36.64279	fixed	10	\N	\N	\N	\N	pending	f	0	\N	\N
4	2	Crypto Trading Bot Premium	Professional cryptocurrency trading bot with AI algorithms. Supports Binance, Bybit, and other major exchanges. Includes risk management and backtesting.	8000000	{https://via.placeholder.com/300x200?text=Crypto+Bot}	Crypto Tools	2025-08-02 06:55:39.432431	2025-08-02 06:55:39.432431	fixed	4	\N	\N	\N	\N	approved	f	7	\N	\N
3	2	Social Media Marketing Bot	Automated social media management tool for Instagram, Facebook, and TikTok. Features auto-posting, engagement automation, and analytics dashboard.	1200000	{https://via.placeholder.com/300x200?text=Social+Bot}	Marketing Tools	2025-08-02 06:55:39.432431	2025-08-02 06:55:39.432431	fixed	8	\N	\N	\N	\N	approved	f	3	\N	\N
9	2	ban Gmail gia re	san pham Gmail gia re nhat thi thuong	10000	\N	Software Licenses	2025-08-04 08:25:47.867482	2025-08-04 08:25:47.867482	fixed	1	https://1000logos.net/wp-content/uploads/2021/05/Gmail-logo-500x281.png	\N	{gmail}	san pham gmail gia re an toan tuyet doi	published	f	0	\N	\N
7	2	Frontend Test Product	This is a test product created from the frontend form	19.99	\N	Software Licenses	2025-08-03 10:55:01.009814	2025-08-03 10:55:01.009814	fixed	5	\N	\N	\N	\N	draft	f	0	\N	\N
11	2	Thay đổi thông tin máy tính trong một click chuột	Hướng dẫn thay đổi info window để làm MMO, Airdrop Gleam, Sweetwidget bằng tool change info - thay đổi thông tin máy chỉ với 1 click\nTính năng của tool: Demo và hướng dẫn tại đây\n1. Công cụ này cho phép người dùng có thể dễ dàng thay đổi thông tin phần cứng của máy tính.\n2. Tên, mã ID, ID khóa bí mật và thông tin ngày cài đặt của máy tính có thể được sửa đổi.\n3. Ví dụ: thay đổi địa chỉ MAC có thể ngăn chặn bot mạng đọc thông tin máy tính của bạn.\n4. Có thể sử dụng nó để đổi BIOS hệ thống nhanh chóng, BIOS của bo mạch chủ và ID thiết bị của máy tính.\n5. Hỗ trợ tính năng sửa đổi BIOS, thông tin bo mạch chủ trực tiếp trong phần mềm. Bằng cách sửa đổi thông tin hệ thống, bạn có thể ngăn chặn phần mềm khác đọc thông tin hệ thống thực.\n6. Bạn có thể sửa đổi bằng một phím bằng cách nhập trực tiếp giá trị có liên quan vào phần mềm.\n7. Thông tin máy tính được sửa đổi bằng công cụ này sẽ không thể được khôi phục bằng một phím và chỉ cho phép bạn cài đặt lại máy hoặc sửa đổi theo cách thủ công.	20000	{https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755177078798-product-images/2/1755177078798.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T131120Z&X-Amz-Expires=604800&X-Amz-Signature=9a9114d6ba40fa5b63887eeb7872bbc42355277ba16f543e973e5353858d34f0&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject,https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755177078231-product-images/2/1755177078231.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T131119Z&X-Amz-Expires=604800&X-Amz-Signature=31a55bfbd19f58b288b90ae6f94da9861fb2c27750bf8d81ee28c76eea42b784&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject}	Productivity	2025-08-14 13:12:06.380658	2025-08-14 13:12:06.380658	Phan mem 1	1	\N	\N	{software}	\N	published	f	0	\N	\N
10	2	Gmail NEW - Live Strong - Random IP - Chưa Dịch Vụ | Live Trâu	ĐỊNH DẠNG: Gmail|Pass|Mail Recovery(Nếu có)\n\nLƯU Ý: Không đăng nhập nhiều Gmail trên cùng 1 trình duyệt - 1 IP\n\nHƯỚNG DẪN ĐĂNG NHẬP TÀI KHOẢN (ĐỌC KỸ)\n\n\nTH1: Đăng nhập báo thêm mail KP hoặc SĐT thì anh em thêm hoặc ấn huỷ là vào mail bình thường:\n\n\n\nTH2: Login có tuỳ trọn xác nhận Mail khôi phục - Ae chọn như hình rồi nhập Mail KP là done\n\n\n\nTH3: Bắt gửi mã xác minh về Mail khôi phục - Không có tuỳ trọn xác nhận Mail KP: \n+ Đối với Mail KP đuôi @hotmail.com - Anh em tạo hotmail trùng với Mail KP rồi nhận mã.\n\n+ Đối với Mail KP đuôi @domain.com - Anh em vào Tinnyhost.shop hoặc khaibn.com nhập Mail KP vào rồi nhận mã: 	10000	{https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755156734629-product-images/2/1755156734629.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T073216Z&X-Amz-Expires=604800&X-Amz-Signature=fb6cfd5843bae1a8b8eba6c9a9aef2c533de2f7ebe700fe599f70b0c0978a244&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject,https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755156735493-product-images/2/1755156735493.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T073218Z&X-Amz-Expires=604800&X-Amz-Signature=67ea7b6d63c8637e63e89a50fd6ed0c9cc3fc170f5104d7c938475651800e090&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject,https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755156734332-product-images/2/1755156734332.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T073215Z&X-Amz-Expires=604800&X-Amz-Signature=5abe5211289ae126cd59365b501fb81b1cb6d4643b71d6714fb3fd955ff9706f&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject}	Software Licenses	2025-08-14 07:33:21.856406	2025-08-14 07:33:21.856406	Gmail New Random IP+ Live Strong - Name US	1	\N	\N	{gmail}	\N	published	f	0	\N	\N
17	2	CLONE Thay đổi thông tin máy tính trong một click chuột	Hướng dẫn thay đổi info window để làm MMO, Airdrop Gleam, Sweetwidget bằng tool change info - thay đổi thông tin máy chỉ với 1 click\nTính năng của tool: Demo và hướng dẫn tại đây\n1. Công cụ này cho phép người dùng có thể dễ dàng thay đổi thông tin phần cứng của máy tính.\n2. Tên, mã ID, ID khóa bí mật và thông tin ngày cài đặt của máy tính có thể được sửa đổi.\n3. Ví dụ: thay đổi địa chỉ MAC có thể ngăn chặn bot mạng đọc thông tin máy tính của bạn.\n4. Có thể sử dụng nó để đổi BIOS hệ thống nhanh chóng, BIOS của bo mạch chủ và ID thiết bị của máy tính.\n5. Hỗ trợ tính năng sửa đổi BIOS, thông tin bo mạch chủ trực tiếp trong phần mềm. Bằng cách sửa đổi thông tin hệ thống, bạn có thể ngăn chặn phần mềm khác đọc thông tin hệ thống thực.\n6. Bạn có thể sửa đổi bằng một phím bằng cách nhập trực tiếp giá trị có liên quan vào phần mềm.\n7. Thông tin máy tính được sửa đổi bằng công cụ này sẽ không thể được khôi phục bằng một phím và chỉ cho phép bạn cài đặt lại máy hoặc sửa đổi theo cách thủ công.	20000	{https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755177078798-product-images/2/1755177078798.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T131120Z&X-Amz-Expires=604800&X-Amz-Signature=9a9114d6ba40fa5b63887eeb7872bbc42355277ba16f543e973e5353858d34f0&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject,https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755177078231-product-images/2/1755177078231.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T131119Z&X-Amz-Expires=604800&X-Amz-Signature=31a55bfbd19f58b288b90ae6f94da9861fb2c27750bf8d81ee28c76eea42b784&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject}	Productivity	2025-08-14 14:00:23.335112	2025-08-14 14:00:23.335112	Phan mem 1	1	\N	\N	{software}	\N	draft	f	0	\N	\N
20	2	CLONE CLONE Thay đổi thông tin máy tính trong một click chuột	Hướng dẫn thay đổi info window để làm MMO, Airdrop Gleam, Sweetwidget bằng tool change info - thay đổi thông tin máy chỉ với 1 click\nTính năng của tool: Demo và hướng dẫn tại đây\n1. Công cụ này cho phép người dùng có thể dễ dàng thay đổi thông tin phần cứng của máy tính.\n2. Tên, mã ID, ID khóa bí mật và thông tin ngày cài đặt của máy tính có thể được sửa đổi.\n3. Ví dụ: thay đổi địa chỉ MAC có thể ngăn chặn bot mạng đọc thông tin máy tính của bạn.\n4. Có thể sử dụng nó để đổi BIOS hệ thống nhanh chóng, BIOS của bo mạch chủ và ID thiết bị của máy tính.\n5. Hỗ trợ tính năng sửa đổi BIOS, thông tin bo mạch chủ trực tiếp trong phần mềm. Bằng cách sửa đổi thông tin hệ thống, bạn có thể ngăn chặn phần mềm khác đọc thông tin hệ thống thực.\n6. Bạn có thể sửa đổi bằng một phím bằng cách nhập trực tiếp giá trị có liên quan vào phần mềm.\n7. Thông tin máy tính được sửa đổi bằng công cụ này sẽ không thể được khôi phục bằng một phím và chỉ cho phép bạn cài đặt lại máy hoặc sửa đổi theo cách thủ công.	20000	{https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755177078798-product-images/2/1755177078798.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T131120Z&X-Amz-Expires=604800&X-Amz-Signature=9a9114d6ba40fa5b63887eeb7872bbc42355277ba16f543e973e5353858d34f0&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject,https://37d4802385891104a8d7620c01919ac8.r2.cloudflarestorage.com/softwarehub/1755177078231-product-images/2/1755177078231.jpg?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=9285979558a4ac7d213ff94b63957e37%2F20250814%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20250814T131119Z&X-Amz-Expires=604800&X-Amz-Signature=31a55bfbd19f58b288b90ae6f94da9861fb2c27750bf8d81ee28c76eea42b784&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject}	Productivity	2025-08-14 15:48:51.721889	2025-08-14 15:48:51.721889	Phan mem 1	1	\N	\N	{software}	CCCCCCCCCCCCCCC|111111111111111111111111	draft	f	0	\N	\N
\.
...
1	3	software	80	5	phan mem ko dung duoc	2025-08-21 11:38:58.326598
2	3	software	78	5	phan mem rat hay	2025-08-21 11:39:42.72483
\.
...
SELECT pg_catalog.setval('public.external_requests_id_seq', 8, true);
