  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-5 right-5 z-40 group transition-all duration-300 ${
      ...
      {isChatOpen && (
        <div 
          className="fixed bottom-24 right-5 w-[380px] max-w-[calc(100vw-40px)] h-[500px] max-h-[calc(100vh-140px)] bg-white rounded-2xl shadow-2xl z-40 flex flex-col animate-in slide-in-from-bottom-4 duration-300"
          style={{
                  ...
                  <div className="p-4">
                    {rooms.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <p className="text-sm text-gray-600">Chưa có cuộc trò chuyện nào</p>
                        <p className="text-xs text-gray-500 mt-1">
                          Liên hệ với seller để bắt đầu chat
                        </p>
                      </div>
                    ) : (
                          ...
                          >
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {room.metadata?.productId && (
                                  <p className="text-xs text-blue-600 mt-1">
                                    📦 Sản phẩm #{room.metadata.productId}
                                  </p>
                                )}
                              </div>
                            </div>
